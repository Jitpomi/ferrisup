...
### Fixed
- Fixed README.md display issue on crates.io
- Simplified README format for better compatibility

## [0.1.10] - 2025-05-24

### Changed
- Updated crates.io metadata to properly display project banner image
