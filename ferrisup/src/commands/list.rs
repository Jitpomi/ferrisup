...
pub fn execute() -> Result<()> {
    ...
    for (template_name, template_description) in templates {
        match template_name.as_str() {
            ...
            "full-stack" => println!(
                "  • {} - {}",
                template_name.magenta().bold(),
                template_description
            ),
            "data-science" => println!(
                "  • {} - {}",
                template_name.blue().bold(),
                template_description
            ),
            "library" => println!(
                "  • {} - {}",
                template_name.yellow().bold(),
                template_description
            ),
            "web-server" => println!(
                "  • {} - {}",
                template_name.green().bold(),
                template_description
            ),
            "cli" => println!(
                "  • {} - {}",
            ...
            "embedded-embassy" => println!(
                "  • {} - {}",
                template_name.cyan().bold(),
                template_description
            ),
            "desktop-dioxus" => println!(
                "  • {} - {}",
                template_name.magenta().bold(),
                template_description
            ),
